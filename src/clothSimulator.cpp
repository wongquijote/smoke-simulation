...
void ClothSimulator::drawWireframe(GLShader &shader) {
  ...
  // I CHANGED THIS LINE (multiplied by cloth->num_depth_points)
  int num_springs = cloth->num_depth_points * (cp->enable_structural_constraints * num_structural_springs +
